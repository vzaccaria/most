...
class st_full_factorial : public st_doe {
public:
  st_full_factorial() {}
...
string st_full_factorial::get_information() { return "Full factorial DoE"; }

st_vector *st_full_factorial::generate_doe(st_env *env) {
...
extern "C" {
st_doe *doe_generate_doe() { return new st_full_factorial(); }
st_command *get_help() {
  const char *ref[] = {NULL};
  ...
  st_command *help = new st_command(
      ...
      "", ref, ref_help,
      "This design of experiments generates Full Factorial design of "
      "experiments. ",
      STDRET);
  help->alt_command_name = "Full Factorial Design of Experiments";
  help->alt_command_synopsys = "doe_load_doe st_full_factorial";
